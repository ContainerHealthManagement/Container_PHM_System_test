...
public class ContainerhealthOper {
	public List<Container_health> selectByXhdm(String xhdm){
		Connection conn = db.Dbconn.getConn();
		java.sql.PreparedStatement pstmt = null;
		java.sql.ResultSet rs = null;
		List<Container_health> data = new ArrayList<Container_health>();
		try {
			pstmt = conn.prepareStatement("select a.XHDM,a.HEALTH_07,a.HEALTH_08,a.HEALTH_09,a.HEALTH_10,a.HEALTH_11,a.HEALTH_12,a.HEALTH_13,a.HEALTH_14,a.HEALTH_15,a.HEALTH_16,a.HEALTH_17,a.HEALTH_18,b.HZZM,b.JSDATE from `TABLE 3` a left join `TABLE 4` b on a.XHDM=b.XHDM where a.XHDM=?");
